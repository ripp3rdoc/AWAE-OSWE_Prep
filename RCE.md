...
> Ripped somw of the collection from [here](https://github.com/timip/OSWE/blob/master/README.md) and added to it for this section <3 

### XSS to RCE 
- [Code Analysis to Gain RCE](https://sarthaksaini.com/2019/awae/xss-rce.html)
- [The Analysis of Mybb 18.20 From Stored XSS to RCE](https://medium.com/@knownsec404team/the-analysis-of-mybb-18-20-from-stored-xss-to-rce-7234d7cc0e72)
- [Magento 2.3.1: Unauthenticated Stored XSS to RCE](https://blog.sonarsource.com/magento-rce-via-xss?redirect=rips)
